...
bool DepthShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, (WCHAR*) L"Graphics/Shaders/depth.vs", (WCHAR*) L"Graphics/Shaders/depth.ps");
	if(!result)
	{
		return false;
	}
...
bool DepthShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DirectX::SimpleMath::Matrix worldMatrix, 
...
bool DepthShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "DepthVertexShader", "vs_5_0", D3DCOMPILE_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "DepthPixelShader", "ps_5_0", D3DCOMPILE_ENABLE_STRICTNESS, 0,
...
bool DepthShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::SimpleMath::Matrix worldMatrix, 
	DirectX::SimpleMath::Matrix viewMatrix, DirectX::SimpleMath::Matrix projectionMatrix)
{
	HRESULT result;
