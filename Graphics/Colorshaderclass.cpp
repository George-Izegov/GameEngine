...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"Graphics/Shaders/TextureShader.fx", L"Graphics/Shaders/TextureShader.fx");
	if (!result)
	{
		return false;
	}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd,const wchar_t* vsFileName,const wchar_t* psFileName)
{
	...
	result = D3DCompileFromFile(vsFileName, NULL, NULL, "VSMain", "vs_5_0", D3DCOMPILE_OPTIMIZATION_LEVEL2, 0,
	...
	result = D3DCompileFromFile(psFileName, NULL, NULL, "PSMain", "ps_5_0", D3DCOMPILE_OPTIMIZATION_LEVEL0, 0,
